                ...
                <section class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <div id="clients-container"class="table-responsive">
        ...
        $(document).ready(function() {
            ...
            $('.filter-toggle').on('click', function() {
                ...
                if ($(this).hasClass('collapsed')) {
                    $(this).removeClass('collapsed').contents().first()[0].textContent =
                        '{{ __('إخفاء') }} ';
                    icon.removeClass('ft-chevron-down').addClass('ft-chevron-up');
                } else {
                    $(this).addClass('collapsed').contents().first()[0].textContent =
                        '{{ __('عرض') }} ';
