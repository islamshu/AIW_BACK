                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-sm">
                                    ...
                                    <form method="POST"
                                          action="{{ route('dashboard.news.destroy',$item) }}"
                                          class="d-inline">
                                        @csrf @method('DELETE')
...
document.querySelectorAll('.js-toggle-news').forEach(sw => {
    sw.addEventListener('change', function () {
        ...
        fetch("http://127.0.0.1:8000/dashboard/news/" + this.dataset.id + "/toggle", {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': 'fjBHUqTtFRyuPQCdi8IaRd8z3cJBMChkwqcQfEJa',
