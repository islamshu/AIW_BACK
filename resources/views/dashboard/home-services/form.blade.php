            ...
            <form method="POST" enctype="multipart/form-data"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        rows="5">{!! old('description.ar', optional($homeService)->getTranslation('description', 'ar')) !!}</textarea>
                                        </div>
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        name="description[en]"
                        class="form-control js-editor"
                        rows="5">{!! old('description.en', optional($homeService)->getTranslation('description', 'en')) !!}</textarea>
                                        </div>
