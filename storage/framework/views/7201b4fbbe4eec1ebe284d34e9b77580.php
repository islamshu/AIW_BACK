...
<?php $__env->startSection('title', 'العناوين الرئيسية للوظائف'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="<?php echo e(route('dashboard.job-groups.create')); ?>" class="btn btn-primary d-flex align-items-center gap-2">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-borderless align-middle job-groups-table mb-0">
                        ...
                        <tbody id="sortable-groups">
                            ...
                            <tr data-id="<?php echo e($group->id); ?>" class="group-row">
                                ...
                                <td class="text-center">
                                    <span class="badge badge-soft-info">
                                        <?php echo e($group->jobs_count); ?> وظيفة
                                    </span>
                                </td>
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center gap-2">
                                        <a href="<?php echo e(route('dashboard.job-groups.edit', $group)); ?>"
                                        ...
                                        <form method="POST"
                                              action="<?php echo e(route('dashboard.job-groups.destroy', $group)); ?>"
                                              class="d-inline js-delete-form">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('DELETE'); ?>
                                            <button type="button"
                                                    class="btn btn-sm btn-light btn-icon text-danger js-delete-btn"
                                                    data-title="<?php echo e($group->getTranslation('title','ar')); ?>">
            ...
            if (tableBody) {
                new Sortable(tableBody, {
                    ...
                    onEnd: function () {
                        ...
                        fetch('<?php echo e(route('dashboard.job-groups.reorder')); ?>', {
                            method: 'POST',
                            headers: {
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\aiw_rtl\resources\views/dashboard/job_groups/index.blade.php ENDPATH**/ ?>