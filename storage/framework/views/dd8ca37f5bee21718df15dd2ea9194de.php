...
<head>
    ...
    <?php else: ?>
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('backend/app-assets/css/vendors.css')); ?>">
        <!-- END VENDOR CSS-->
        <!-- BEGIN MODERN CSS-->
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('backend/app-assets/css/app.css')); ?>">
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('backend/app-assets/css/custom.css')); ?>">
        <link rel="stylesheet" type="text/css"
            href="<?php echo e(asset('backend/app-assets/css/core/menu/menu-types/horizontal-menu.css')); ?>">
        <link rel="stylesheet" type="text/css"
            href="<?php echo e(asset('backend/app-assets/css/core/colors/palette-gradient.css')); ?>">
        <link rel="stylesheet" type="text/css"
            href="<?php echo e(asset('backend/app-assets/css/core/colors/palette-gradient.css')); ?>">
  ...
  <div class="app-content content login-wrapper">
    <div class="login-card">
      ...
      <h6 class="text-center text-dark login-title">
        <?php echo e(__('تسجيل دخول ')); ?> <?php echo e(get_general_value('website_name_' . app()->getLocale())); ?>

      </h6>

      <?php echo $__env->make('dashboard.inc.alerts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

      <form method="POST" action="<?php echo e(route('post_login')); ?>" class="mt-3">
        <?php echo csrf_field(); ?>

        <fieldset class="form-group position-relative has-icon-left">
          <input type="email"  name="email" class="form-control form-control-lg" placeholder="<?php echo e(__('البريد الإلكتروني')); ?>" required>
        ...
        <fieldset class="form-group position-relative has-icon-left mt-2">
          <input type="password"  name="password" class="form-control form-control-lg" placeholder="<?php echo e(__('كلمة المرور')); ?>" required>
          <div class="form-control-position">
            <i class="ft-lock"></i>
          </div>
        </fieldset>
        ...
        <button type="submit" class="btn btn-info btn-lg btn-block mt-2">
          <i class="ft-unlock"></i> <?php echo e(__('تسجيل دخول')); ?>
...
<?php /**PATH C:\laragon\www\aiw_rtl\resources\views/auth/login.blade.php ENDPATH**/ ?>