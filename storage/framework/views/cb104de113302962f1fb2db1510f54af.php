...
<section class="py-20 relative overflow-hidden"
    ...
    <div class="container mx-auto px-4 relative z-10">
                ...
                <div class="rounded-2xl overflow-hidden fade-in
                    ...
                    <div class="relative h-48 overflow-hidden">
                        ...
                        <div class="w-full h-full flex items-center justify-center"
                            ...
                            ">
                            <?php if($sector->icon): ?>
                                <i class="<?php echo e($sector->icon); ?> text-white text-6xl"></i>
                            <?php endif; ?>
                        </div>
        ...
        <?php if(get_general_value(key: 'sectors_enabled') && $count > count($sectors)): ?>
            <div class="text-center mt-12 fade-in">
                <a href="/sectors"
                    ...
                    ">
                    <span> <?php echo e(app()->getLocale() === 'ar' ? 'رؤية جميع القطاعات' : 'View All Sectors'); ?>
