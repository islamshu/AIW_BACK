    ...
    <div class="container-fluid py-4">
        ...
        <?php if($available->count()): ?>
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('dashboard.home-sections.store')); ?>" class="form-inline">
                        <?php echo csrf_field(); ?>
                    ...
                    <tbody id="sortable-sections">
                        <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr class="section-row" data-id="<?php echo e($section->id); ?>">
                                ...
                                <td>
                                    <label class="switch">
                                        <input type="checkbox" class="js-switch-toggle" data-id="<?php echo e($section->id); ?>"
            ...
            <div class="modal-content">
                ...
                <form id="textForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>نص الزر (انجليزي)</label>
                            <input id="button_text_en" class="form-control">
                        </div>
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="heroForm">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger mr-auto" id="deleteHeroSection">
                ...
                fetch(`/dashboard/home-sections/${activeSectionId}/content`)
                    ...
                    .then(data => {
                        ...
                        if (activeSectionKey === 'text') {
                            ...
                            button_link_ar.value = data.button_link ?? '';
        ...
        document.getElementById('textForm').addEventListener('submit', e => {
            ...
            fetch(`/dashboard/home-sections/${activeSectionId}/content`, {
                    ...
                    body: JSON.stringify({
                        ...
                        button_link: button_link_ar.value
                    })
