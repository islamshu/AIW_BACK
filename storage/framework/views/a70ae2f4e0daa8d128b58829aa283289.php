...
<?php $__env->startSection('title','إحصائيات الصفحة الرئيسية'); ?>
...
<form method="POST" action="<?php echo e(route('home-stats.update')); ?>" id="statsForm">
<?php echo csrf_field(); ?>
...
<tr class="stat-row">
    ...
    <td>
        <input type="text" class="form-control"
               data-field="value"
               value="<?php echo e($stat->value); ?>">
    </td>

    <td>
        <input type="text" class="form-control"
               data-field="label.ar"
               value="<?php echo e($stat->getTranslation('label','ar')); ?>">
    </td>

    <td>
        <input type="text" class="form-control"
               data-field="label.en"
               value="<?php echo e($stat->getTranslation('label','en')); ?>">
    </td>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\aiw_rtl\resources\views/dashboard/home-stats/edit.blade.php ENDPATH**/ ?>