    ...
    public function dashboard()
{
    return view('dashboard.index', [
        'servicesCount' => HomeService::count(),
        'activeServices' => HomeService::where('is_active', 1)->count(),
        'sectorsCount' => Sector::count(),
        'activeSectors' => Sector::where('is_active', 1)->count(),
        'visits' =>0, // لو عندك جدول زيارات
    ]);
}
